...
//	}
    ...
    // Baudios de transmisión
    private int mBaudrate=115200;	//set the default baud rate to 115200
    // Contraseña mandada por comando at= DRRobot
    private String mPassword="AT+PASSWOR=DFRobot\r\n";

    // variable que establece la velocidad en baudios a bluno
    private String mBaudrateBuffer = "AT+CURRUART="+mBaudrate+"\r\n";

//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;

    // Función que establece la velocidad en baudios a bluno
    public void serialBegin(int baud){
        mBaudrate=baud;
        mBaudrateBuffer = "AT+CURRUART="+mBaudrate+"\r\n";
    }

    // Función que establece los componentes para la vista emergente de los dispostivos bluetooth
    static class ViewHolder {
        TextView deviceName;
        TextView deviceAddress;
    }

    // Variables estatica que contienen las caracteristicas de las
    private static BluetoothGattCharacteristic mSCharacteristic, mModelNumberCharacteristic, mSerialPortCharacteristic, mCommandCharacteristic;
    BluetoothLeService mBluetoothLeService;

    // array en el cual se obtienen las caracteristicas del dispositivo seleccionado
